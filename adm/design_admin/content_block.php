...
$pg_anchor = '';
$edit_theme = isset($edit_theme) ? $edit_theme : 'default';
            ...
            <td>
              <span class="frm_info">테마는 <a href="https://codemirror.net/demo/theme.html" target="_blank">https://codemirror.net/demo/theme.html</a> 에서 미리보기 가능합니다 .</span>
                <select name="theme" id="theme">
                  <option value="default" <?php if($edit_theme == 'default'){echo 'selected';}?>>default</option>
                  <option value="3024-day" <?php if($edit_theme == '3024-day'){echo 'selected';}?>>3024-day</option>
                  <option value="3024-night" <?php if($edit_theme == '3024-night'){echo 'selected';}?>>3024-night</option>
                  <option value="abcdef" <?php if($edit_theme == 'abcdef'){echo 'selected';}?>>abcdef</option>
                  <option value="ambiance" <?php if($edit_theme == 'ambiance'){echo 'selected';}?>>ambiance</option>
                  <option value="base16-dark" <?php if($edit_theme == 'base16-dark'){echo 'selected';}?>>base16-dark</option>
                  <option value="base16-light" <?php if($edit_theme == 'base16-light'){echo 'selected';}?>>base16-light</option>
                  <option value="bespin" <?php if($edit_theme == 'bespin'){echo 'selected';}?>>bespin</option>
                  <option value="blackboard" <?php if($edit_theme == 'blackboard'){echo 'selected';}?>>blackboard</option>
                  <option value="cobalt" <?php if($edit_theme == 'cobalt'){echo 'selected';}?>>cobalt</option>
                  <option value="colorforth" <?php if($edit_theme == 'colorforth'){echo 'selected';}?>>colorforth</option>
                  <option value="darcula" <?php if($edit_theme == 'darcula'){echo 'selected';}?>>darcula</option>
                  <option value="dracula" <?php if($edit_theme == 'dracula'){echo 'selected';}?>>dracula</option>
                  <option value="duotone-dark" <?php if($edit_theme == 'duotone-dark'){echo 'selected';}?>>duotone-dark</option>
                  <option value="duotone-light" <?php if($edit_theme == 'duotone-light'){echo 'selected';}?>>duotone-light</option>
                  <option value="eclipse" <?php if($edit_theme == 'eclipse'){echo 'selected';}?>>eclipse</option>
                  <option value="elegant" <?php if($edit_theme == 'elegant'){echo 'selected';}?>>elegant</option>
                  <option value="erlang-dark" <?php if($edit_theme == 'erlang-dark'){echo 'selected';}?>>erlang-dark</option>
                  <option value="gruvbox-dark" <?php if($edit_theme == 'gruvbox-dark'){echo 'selected';}?>>gruvbox-dark</option>
                  <option value="hopscotch" <?php if($edit_theme == 'hopscotch'){echo 'selected';}?>>hopscotch</option>
                  <option value="icecoder" <?php if($edit_theme == 'icecoder'){echo 'selected';}?>>icecoder</option>
                  <option value="idea" <?php if($edit_theme == 'idea'){echo 'selected';}?>>idea</option>
                  <option value="isotope" <?php if($edit_theme == 'isotope'){echo 'selected';}?>>isotope</option>
                  <option value="lesser-dark" <?php if($edit_theme == 'lesser-dark'){echo 'selected';}?>>lesser-dark</option>
                  <option value="lucario" <?php if($edit_theme == 'lucario'){echo 'selected';}?>>lucario</option>
                  <option value="material" <?php if($edit_theme == 'material'){echo 'selected';}?>>material</option>
                  <option value="mbo" <?php if($edit_theme == 'mbo'){echo 'selected';}?>>mbo</option>
                  <option value="mdn-like" <?php if($edit_theme == 'mdn-like'){echo 'selected';}?>>mdn-like</option>
                  <option value="midnight" <?php if($edit_theme == 'midnight'){echo 'selected';}?>>midnight</option>
                  <option value="monokai" <?php if($edit_theme == 'monokai'){echo 'selected';}?>>monokai</option>
                  <option value="neat" <?php if($edit_theme == 'neat'){echo 'selected';}?>>neat</option>
                  <option value="neo" <?php if($edit_theme == 'neo'){echo 'selected';}?>>neo</option>
                  <option value="night" <?php if($edit_theme == 'night'){echo 'selected';}?>>night</option>
                  <option value="oceanic-next" <?php if($edit_theme == 'oceanic-next'){echo 'selected';}?>>oceanic-next</option>
                  <option value="panda-syntax" <?php if($edit_theme == 'panda-syntax'){echo 'selected';}?>>panda-syntax</option>
                  <option value="paraiso-dark" <?php if($edit_theme == 'paraiso-dark'){echo 'selected';}?>>paraiso-dark</option>
                  <option value="paraiso-light" <?php if($edit_theme == 'paraiso-light'){echo 'selected';}?>>paraiso-light</option>
                  <option value="pastel-on-dark" <?php if($edit_theme == 'pastel-on-dark'){echo 'selected';}?>>pastel-on-dark</option>
                  <option value="railscasts" <?php if($edit_theme == 'railscasts'){echo 'selected';}?>>railscasts</option>
                  <option value="rubyblue" <?php if($edit_theme == 'rubyblue'){echo 'selected';}?>>rubyblue</option>
                  <option value="seti" <?php if($edit_theme == 'seti'){echo 'selected';}?>>seti</option>
                  <option value="shadowfox" <?php if($edit_theme == 'shadowfox'){echo 'selected';}?>>shadowfox</option>
                  <option value="the-matrix" <?php if($edit_theme == 'the-matrix'){echo 'selected';}?>>the-matrix</option>
                  <option value="tomorrow-night-bright" <?php if($edit_theme == 'tomorrow-night-bright'){echo 'selected';}?>>tomorrow-night-bright</option>
                  <option value="tomorrow-night-eighties" <?php if($edit_theme == 'tomorrow-night-eighties'){echo 'selected';}?>>tomorrow-night-eighties</option>
                  <option value="ttcn" <?php if($edit_theme == 'ttcn'){echo 'selected';}?>>ttcn</option>
                  <option value="twilight" <?php if($edit_theme == 'twilight'){echo 'selected';}?>>twilight</option>
                  <option value="vibrant-ink" <?php if($edit_theme == 'vibrant-ink'){echo 'selected';}?>>vibrant-ink</option>
                  <option value="xq-dark" <?php if($edit_theme == 'xq-dark'){echo 'selected';}?>>xq-dark</option>
                  <option value="xq-light" <?php if($edit_theme == 'xq-light'){echo 'selected';}?>>xq-light</option>
                  <option value="yeti" <?php if($edit_theme == 'yeti'){echo 'selected';}?>>yeti</option>
                  <option value="zenburn" <?php if($edit_theme == 'zenburn'){echo 'selected';}?>>zenburn</option>
                </select>
