...
<?php
$sql1 = " select * from g5_block_setup where setup_2 = 'css' and setup_1 = 'y' and name not in ('default_shop','default','mobile_shop','mobile') ";
$result1 = sql_query($sql1);

for ($i=0; $row1=sql_fetch_array($result1); $i++) {
?>
<link rel="stylesheet" href="<?=G5_THEME_URL.'/css/'.$row1['name']?>.css">
<?php }?>
<?php
$shop_css = '';
