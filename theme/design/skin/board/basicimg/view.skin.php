...
<style>
    ...
    .vst-view-cate { color: #3235cd; font-weight: 700; font-size: 14px; margin-bottom: 10px; display: block; }
    ...
    /* 본문 영역 */
    .vst-view-content { min-height: 300px; font-size: 16px; line-height: 1.8; color: #333; margin: 40px 0; word-break: break-all; }
    .vst-view-content img { max-width: 100%; height: auto; border-radius: 8px; margin: 20px 0; }

    /* 첨부파일 & 링크 박스 */
    .vst-file-box { background: #f8f9fa; border-radius: 8px; padding: 15px 20px; margin-bottom: 10px; border: 1px solid #eee; }
    .vst-file-box ul { margin: 0; padding: 0; list-style: none; }
    .vst-file-box li { padding: 8px 0; border-bottom: 1px solid #eee; font-size: 13px; display: flex; align-items: center; flex-wrap: wrap; gap: 10px; }
    ...
    .vst-file-info { color: #888; font-size: 12px; margin-left: auto; }

    /* 추천/비추천 버튼 */
    .vst-action-box { text-align: center; margin: 50px 0; }
    .vst-btn-action { 
        display: inline-flex; flex-direction: column; align-items: center; justify-content: center;
        width: 80px; height: 80px; border-radius: 50%; border: 1px solid #ddd; 
        background: #fff; color: #555; transition: 0.2s; text-decoration: none; margin: 0 5px;
    }
    .vst-btn-action i { font-size: 24px; margin-bottom: 5px; color: #888; }
    ...
    .vst-btn { 
        ...
        border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer; text-decoration: none; transition: 0.2s; 
    }
    .vst-btn:hover { border-color: #333; color: #333; }
    ...
    @media (max-width: 768px) {
        .vst-view-wrap { padding: 20px; margin-top: 150px; }
        .vst-view-title { font-size: 20px; }
...
<div class="vst-view-wrap">
    ...
    <div class="vst-view-head">
        ...
        <div class="vst-view-info">
            ...
            <div class="vst-info-right">
                ...
                <span class="vst-info-item"><i class="fa fa-comment-o"></i> <?php echo number_format($view['wr_comment']) ?></span>
            </div>
        </div>
    </div>
        ...
        ?>
            <li>
                ...
                <span class="vst-file-info">
                    (<?php echo $view['file'][$i]['size'] ?>) | <?php echo $view['file'][$i]['download'] ?>회 다운로드
                </span>
            </li>
        <?php
            }
    ...
    <div class="vst-view-content" id="bo_v_atc">
        <?php
        // 파일 이미지 출력
        ...
        <?php if ($is_signature) { ?><p style="margin-top:50px; color:#888; font-size:13px;"><?php echo $signature ?></p><?php } ?>
    </div>
