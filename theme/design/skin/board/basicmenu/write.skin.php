...
<div class="vst-write-wrap">
    ...
    <div class="vst-form-group">
        <label for="wr_subject" class="vst-label"><i class="fa fa-circle"></i> 메뉴명</label>
        <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="vst-input" placeholder="메뉴명을 입력해주세요.">
    </div>

    <div class="vst-form-group">
        <label for="wr_subject" class="vst-label"><i class="fa fa-circle"></i> 영문메뉴명</label>
        <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="vst-input" placeholder="영문메뉴명을 입력해주세요.">
    </div>
    <div class="vst-form-group">
        <label for="wr_subject" class="vst-label"><i class="fa fa-circle"></i> 가격</label>
        <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" required class="vst-input" placeholder="가격을 입력해주세요.">
    </div>

    <div class="vst-form-group">
        <label for="wr_content" class="vst-label"><i class="fa fa-circle"></i> 메뉴설명</label>
    ...
    <div class="vst-file-wrap">
        <label class="vst-label"><?php echo ($i==0) ? '메뉴사진' : '팝업사진'; ?> #<?php echo $i+1 ?></label>
