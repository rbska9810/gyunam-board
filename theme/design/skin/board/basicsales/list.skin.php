    ...
    <div class="vst-list-item <?php echo $is_notice ?>">
        ...
        <div class="vst-col-subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10 + 15) : '15'; ?>px">
            <?php if ($is_category && $list[$i]['ca_name']) { ?>
                <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="vst-badge" style="background:#eee; color:#555; text-decoration:none;"><?php echo $list[$i]['ca_name'] ?></a>
            <?php } ?>
            ...
            <a href="<?php echo $list[$i]['href'] ?>">
                ...
                <?php if (isset($list[$i]['icon_file']) && $list[$i]['icon_file']) echo '<i class="fa fa-download" style="color:#aaa; margin-left:5px; font-size:12px;"></i>'; ?>
                <?php if (isset($list[$i]['icon_link']) && $list[$i]['icon_link']) echo '<i class="fa fa-link" style="color:#aaa; margin-left:5px; font-size:12px;"></i>'; ?>
            </a>
        </div>
        ...
        <div class="vst-info-row" style="display:contents;"> <div class="vst-col-writer"><?php echo $list[$i]['name'] ?></div>
            ...
            <?php if ($is_good) { ?><div class="vst-col-good"><i class="fa fa-thumbs-up" style="margin-right:3px;"></i><?php echo $list[$i]['wr_good'] ?></div><?php } else { ?><div></div><?php } ?>
        </div>
